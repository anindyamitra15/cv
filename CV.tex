...
\begin{tikzpicture}
    ...
    \node at (0,-.5) {\includegraphics[width = 2.65cm]{photo.jpg}}; 
...
\begin{minipage}[c]{0.6\textwidth}
    ...
    \href{Tel:+919903068420}{+91 990-306-8420}
\end{minipage}

\begin{comment}
I am passionate about electronics and have expertise in it.
I have worked on personal projects on power, analog, and digital electronics.
I’ve also worked with microcontrollers for companies, which I’ve mentioned in this CV.
As a plus, I also know how to work with Linux environments
and programming in several languages.
\end{comment}
...
%      \CVItemListEnd
\CVSubheading
{Analog Design Senior Engineer Full Time}{July 2025 -- Present}
{Synopsys, Inc.}{Bagmane Capital Tech Park, Bangalore}
\CVItemListStart
\CVItem{Successfully taped out 2 Memory PHY Projects on latest technodes}
\CVItem{Worked on digital delay line macro, reduced timing validation effort by 40\%}
\CVItemListEnd
\CVSubheading
...
\section{Skills}
 \begin{itemize}[leftmargin=0.5cm, label={}]
    \small{\item{
     ...
     \textbf{Programming}{: Python, MATLAB, Arduino, Verilog, Java, C/C++, HTML, Javascript} \\
...
%      {Institution you worked with}{unused}
    ...
    \CVSubheading
      {{Variable Gain Fully Differential Amplifier on SCL 180nm PDK} $|$ \emph{\small{M.Tech Final Project}}}{Summer 2025}
      {IIEST Shibpur}{}
    \CVItemListStart
      \CVItem{1.8V Single rail operation, Fully Differential Output}
      \CVItem{Chopper Amplifier with digitally-tunable wide-range amplification}
      \CVItem{Chopper Current-mode Bandgap Reference circuit}
    \CVItemListEnd 
...
%      {Who you worked for}{Where they are located}
    \CVSubheading
      {VLSID Conference 2024}{January 2024}
      {Volunteer from IIEST Shibpur}{ITC Royal Bengal, Kolkata}
    \CVSubheading
      {International Symposium on Devices, Circuits and Systems 2025}{May 2025}
      {Volunteer from IIEST Shibpur}{Hotel Hindustan International, Kolkata}
    % \CVSubheading
